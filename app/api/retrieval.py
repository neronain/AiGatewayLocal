...
async def _forward(
    ...
    while True:
        ...
        if response.status_code >= 400:
            ...
            # จึงไม่ใช่การรั่วข้ามคน
            #
            # **ตัดสินแล้วว่าคงไว้เหมือนเส้นทาง chat** (2026-09-21) · เส้นทาง chat ส่ง
            # body ของผู้ใช้ขึ้นไปและส่ง error กลับมาแบบเดียวกันเป๊ะ การปิดเฉพาะที่นี่จึง
            # เป็นการสร้างนโยบายสองมาตรฐานโดยไม่มีอะไรมารองรับว่าทำไมสองเส้นทางนี้ต่างกัน
